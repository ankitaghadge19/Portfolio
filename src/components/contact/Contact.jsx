...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_je8wz7h', 'template_ifrtab7', form.current, '67eQReqleGXVj9UKZ')
      ...
      <div className="container contact__container">
        <div className="contact__options">
          ...
          <article className='contact__option'>
            ...
            <h4>WhatsApp</h4>
            <h5>+91 9767754276</h5>
            <a href="https://api.whatsapp.com/send?phone=9767754276" target='_blank'>Send a message</a>
          </article>
        </div>
